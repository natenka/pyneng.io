...
В отриманому результаті завдання, може також відрізнятися тип даних. Наприклад, за
...
![passed](https://pyneng.io/assets/images/pyneng10.png)

Окремо перевіряється чи повертає функція якесь значення, якщо ні, тест пише:

![passed](https://pyneng.io/assets/images/pyneng9.png)
