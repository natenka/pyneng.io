...
Усі приклади, що використовуються у книзі, знаходяться у [репозиторії](https://github.com/natenka/pynenguk-examples).
...
Всі завдання та допоміжні файли можна отримати в [репозиторії](https://github.com/natenka/pynenguk-tasks),
...
[Для всіх завдань є "відповіді", а точніше варіанти рішень](https://github.com/natenka/pyneng-tasks-solutions).
