...
* налагоджувач у редакторах для початківців: [Mu](https://codewith.mu/), [Thonny](https://thonny.org/)
* print
* якщо досвід у програмуванні вже є, швидше за все, також підійдуть налагоджувачі в IDE
