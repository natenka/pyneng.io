...
* отладчики в редакторах для начинающих: [Mu](https://codewith.mu/), [Thonny](https://thonny.org/)
...
выполнением, поэтому по этому подразделу также [записана серия видео](https://youtube.com/playlist?list=PLah0HUih_ZRn4dqRyC-KeBeiZ07i3zQ6A).
...
* [сайт pythontutor](https://pythontutor.com/)
* [pdb](https://docs.python.org/3/library/pdb.html) - модуль стандартной библиотеки Python (есть много разновидностей pdbr, ipdb, pdbpp)
...
`видео (pdb рассматривается в частях 11, 13, 14)](https://youtube.com/playlist?list=PLah0HUih_ZRn4dqRyC-KeBeiZ07i3zQ6A).
